...
namespace HotelBookingDotNetCore.Controllers
{
    public class GuestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GuestID,FirstName,LastName,Address,PhoneNumber,PostCode,Suburb,State,Country")] Guest guest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GuestID,FirstName,LastName,Address,PhoneNumber,PostCode,Suburb,State,Country")] Guest guest)
        {
            if (id != guest.GuestID)
            {
                return NotFound();
